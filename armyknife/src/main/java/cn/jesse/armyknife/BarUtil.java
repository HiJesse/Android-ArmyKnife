...
/**
 * bar 相关工具
 * Created by jesse on 18/08/2017.
 */

public class BarUtil {
    private static final String TAG = BarUtil.class.getSimpleName();
    ...
    public static int getNavBarHeight() {
        boolean hasMenuKey = ViewConfiguration.get(ContextUtil.getContext()).hasPermanentMenuKey();
